...
export default function SettingsPage() {
  ...
  const saveOutput = (value: string) => { setOutputTokens(value); localStorage.setItem("judu:maxOutputTokens", value); };
  const saveCompression = (value: string) => { setCompression(value); localStorage.setItem("judu:compressionStrategy", value); };
  const saveReadingDetail = (value: string) => { const normalized = normalizeReadingDetail(value); setReadingDetail(normalized); localStorage.setItem("judu:readingDetail", normalized); };
