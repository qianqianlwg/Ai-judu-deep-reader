...
function valid(): MobiLayoutSnapshot { return {schema:'mobi-layout-untrusted-v2',kind:'kf8',sourceHash:'a'.repeat(64),title:'书',authors:['作者'],cover:'mobi-resource-v1/1.png',chapters:[{id:'0',title:'章',html:'<p id="p">文</p>',head:'<style>p{color:red}</style>',css:['mobi-resource-v1/1.css'],paragraphs:['文']}],resources:[{id:'mobi-resource-v1/1.png',mediaType:'image/png',bytes:new Uint8Array([1,2])},{id:'mobi-resource-v1/1.css',mediaType:'text/css',bytes:new Uint8Array([65])}],toc:[{label:'章',href:'kindle:pos:fid:0000:off:0000',depth:0,target:{chapterId:'0',locator:'kindle:pos:fid:0000:off:0000',byteOffset:0,htmlOffset:0,point:{kind:'element',path:[0],tag:'p',offset:0}}}],links:[{chapterId:'0',href:'https://invalid.example/',target:null,reason:'external'}]}; }
