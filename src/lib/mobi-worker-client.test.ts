...
describe("布局IPC单独验证而不误用旧文字协议",()=>{
 const snapshot={schema:'mobi-layout-untrusted-v2',kind:'mobi',sourceHash:'a'.repeat(64),title:'书',authors:[],cover:null,resources:[],chapters:[{id:'0',title:'章',head:'',html:'<p>文</p>',paragraphs:['文'],css:[]}],toc:[],links:[]};
