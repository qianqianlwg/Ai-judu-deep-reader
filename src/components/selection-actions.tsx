...
export type SelectionActionsProps = { left:number; top:number; disabled?:boolean; analyzeDisabled?:boolean; reason?:string; onClose?:()=>void; onAnalyze:()=>void; onHighlight:(color:ReadingMarkColor)=>void; onFavorite:()=>void; onNote:(text:string)=>void };
export function SelectionActions({left,top,disabled=false,analyzeDisabled=false,reason,onClose,onAnalyze,onHighlight,onFavorite,onNote}:SelectionActionsProps){
