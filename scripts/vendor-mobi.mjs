...
const manifest = JSON.stringify({package:pkg.name,version:pkg.version,license:'MIT',sourceSha256:sha256(input),licenseSha256:sha256(license),patchedSha256:sha256(result),patches:['absent-EXTH','single-flow-KF8-FDST','bounded-raw-flow','last-MOBI-byte-range','body-tag-attributes','exclusive-resource-write','zero-cover-offset','optional-image-recindex','preserve-layout-head','bounded-resource-write','stable-resource-ids','semantic-resource-rewrite','source-byte-ranges','source-body-projection','resource-provenance','pagebreak-context'],generator:'scripts/vendor-mobi.mjs'},null,2)+'\n';
